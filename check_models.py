...
course = Course(id=15, name='Al', student_number = 2,  tutor_id=1, students = [student6, student7])
course1 = Course(id=40, name='Al', student_number = 2, tutor_id=7, students = [student6, student7])
